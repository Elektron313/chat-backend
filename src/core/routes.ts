...
import {loginValidation, registration } from "../utils/validations";

import { UserCtrl, DialogCtrl, MessageCtrl, UploadFileCtrl } from "../controllers";
import uploader from './multer';

const createRoutes = (app: express.Express, io: socket.Namespace) => {
    ...
    app.post("/user/registration", registration, UserController.create);
